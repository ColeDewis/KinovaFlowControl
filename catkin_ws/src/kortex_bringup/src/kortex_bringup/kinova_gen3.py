...
class KinovaGen3(object):
        ...
        try:
            ...
            if read_joint_state:
                ...
                self.joint_state_sub = rospy.Subscriber(
                    "/{}/joint_states".format(self.robot_name),
                    JointState,
            ...
            self.cartesian_vel_pub = rospy.Publisher(
                "/{}/in/cartesian_velocity".format(self.robot_name),
                TwistCommand,
                queue_size=10,
            )
            self.joint_speed_pub = rospy.Publisher(
                "/{}/in/joint_velocity".format(self.robot_name),
                Base_JointSpeeds,
                queue_size=10,
            )
    ...
    def _init_gen3_services(self):
        ...
        try:
            ...
            send_joint_speeds_command_full_name = (
                "/{}/base/send_joint_speeds_command".format(self.robot_name)
            )
            ...
            # For Twist
            send_twist_command_full_name = "/{}/base/send_twist_command".format(
                self.robot_name
            )
    ...
    def send_joint_angles(
        ...
        # Send the angles
        # print(trajectory)
        rospy.loginfo(f"Sending the joint angles... {angles}")
    ...
    def send_joint_speeds_topic(
        ...
        for i in range(len(vels)):
            ...
            joint_speed.joint_identifier = i
            joint_speed.value = vel
            msg.joint_speeds.append(joint_speed)
    ...
    def send_pose(
        ...
        theta_y,
        theta_z,
        trans_speed_limit=0.2,
        rot_speed_limit=20.0,
    ):
